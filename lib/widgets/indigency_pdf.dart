...
static const double logoRightMargin = 107.0; // Right margin to keep text centered
              ...
              pw.RichText(
                ...
                text: pw.TextSpan(
                  ...
                  children: [
                    ...
                    pw.TextSpan(text: ', of legal age, Filipino Citizen, is a resident of this barangay, known to me as having inadequate income and found to be indigent.'),
                  ],
                ),
              ),
              pw.SizedBox(height: 28),
  ...
  static Future<void> generateAndDownload({
    ...
    try {
      ...
      final fileName = '$name - Barangay Indigency.pdf';
