      ...
      child: Column(
        ...
        children: [
          ...
          _buildProcessStep(
            1,
            'Submit Application',
            'Complete the indigency certificate application form with your details',
            Icons.edit_document,
            true,
          ),
          _buildProcessStep(
            2,
            'Review & Approval',
            'Barangay officials will review and approve your certificate',
            Icons.verified,
            false,
          ),
          _buildProcessStep(
